...
#load weapon images
sword_image = scale_img(pygame.image.load("assets/images/weapons/bow.png").convert_alpha(), constants.WEAPON_SCALE)
bow_image = scale_img(pygame.image.load("assets/images/weapons/bow.png").convert_alpha(), constants.WEAPON_SCALE)
bull_image = scale_img(pygame.image.load("assets/images/weapons/bullet.png").convert_alpha(), constants.WEAPON_SCALE)
...
# bow = Gun(bull_image, bullet_image)
# bow = Sword(bull_image, bullet_image)
# sword = Gun()
      ...
      if player.alive == False:
        if death_fade.fade():
          if restart_button.draw(screen):
            ...
            for item in world.item_list:
              item_group.add(item)
          # Hiệu ứng rung màn hình khi bị tấn công
    # if player.hit:
    #     screen_shake = 5
    # if screen_shake > 0:
    #     shake_offset = shake_screen(screen_shake)
    #     screen.blit(screen, (shake_offset[0], shake_offset[1]))
    #     screen_shake -= 1

        # Hiệu ứng ánh sáng
        # def draw_light_effect(surface):
        #     light_surface = pygame.Surface((constants.SCREEN_WIDTH, constants.SCREEN_HEIGHT), pygame.SRCALPHA)
        #     pygame.draw.circle(light_surface, (255, 255, 255, 100), player.rect.center, 150)
        #     surface.blit(light_surface, (0, 0), special_flags=pygame.BLEND_RGBA_ADD)
        # draw_light_effect(screen)
